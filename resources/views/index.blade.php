    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
        ...
        <div class="offcanvas-body">
            <div class="dropdown my-3">
                <button type="button" id="addLineBtn" class="btn btn-outline-info" style="width: 100%;">Add Line</button>
            </div>
            <div class="dropdown my-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">     
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="undergroundType">Metro</label>
                        </div>
                        <div class="form-check">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="saveStation">Save Station</button>
                </div>
            </div>
        </div>
    </div>

    <div id="addLineModal" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <button id="addStationBtn" class="btn btn-outline-dark mt-2" style="width: 100%;">+</button>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success" id="submitLine">Submit</button>
                </div>
            </div>
        </div>
    </div>
